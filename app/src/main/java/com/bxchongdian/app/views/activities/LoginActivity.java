...
import com.bxchongdian.app.BuildConfig;
...
import com.bxchongdian.presenter.login.LoginContract;
import com.bxchongdian.presenter.login.LoginPresenter;
        ...
        switch (view.getId()) {
            ...
            case R.id.login_bt_login:
                ...
                if (LvTextUtil.isEmpty(pwd)) {
                    ...
                    LoginRequest request = new LoginRequest(phone, pwd,"0023");
