...
import com.bxchongdian.app.wigets.flexbox.TagFlowLayout;
import com.bxchongdian.app.wigets.flexbox.adapters.GunTagAdapter;
import com.bxchongdian.app.wigets.flexbox.interfaces.OnFlexboxSubscribeListener;
import com.bxchongdian.model.bean.ItemGunsBean;
...
import com.bxchongdian.presenter.appointment.QueryOrderContract;
import com.bxchongdian.presenter.appointment.QueryOrderPresenter;
import com.bxchongdian.presenter.main.StationDetailContract;
import com.bxchongdian.presenter.main.StationDetailPresenter;
...
//                            String url = "https://mobile.umeng.com/";
                       //     String url = "https://www.pgyer.com/Buca";
                            String url = "https://www.pgyer.com/Cim7";

                            UMWeb web = new UMWeb(url);
                            /*web.setTitle("欢迎使用杰电APP");
                            web.setDescription("绿色,节能,低碳,畅享健康生活，北京双杰电动汽车充电桩欢迎您!");*/
                            web.setTitle("欢迎使用百祥充电APP");
                            web.setDescription("绿色,节能,低碳,畅享健康生活，山西百祥盛世网络科技有限公司电动汽车充电桩欢迎您!");
