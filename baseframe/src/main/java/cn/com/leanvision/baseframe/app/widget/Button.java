...
public abstract class Button extends CustomView {
  ...
  public Button(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    clickAfterRipple = attrs.getAttributeBooleanValue(MATERIAL_DESIGN_XML,
        "animate", true);
    setAttributes(attrs);
  ...
  protected void setDefaultProperties() {
    // Min size
    setMinimumHeight(LvPhoneUtils.dip2px(getContext(), minHeight));
    setMinimumWidth(LvPhoneUtils.dip2px(getContext(), minWidth));
    // Background shape
  ...
  public Bitmap makeCircle() {
    Bitmap output = Bitmap.createBitmap(
        getWidth() - LvPhoneUtils.dip2px(getContext(), 6), getHeight()
            - LvPhoneUtils.dip2px(getContext(), 7), Config.ARGB_8888);
